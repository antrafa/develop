...
class AMRAPScreen extends Component {
    ...
    render() {
        if(this.state.isRunning){
            ...
            const media = this.state.repetitions > 0 ? parseInt(this.state.count / this.state.repetitions) : 0
            ...
            return(
                <BackgroundProgress percentage={percMinute}>
                    <View style={styles.containerContagem}>
                        <KeepAwake />
                        <View style={{flex: 1}}>
                            <Title title={'AMRAP'} subtitle={'As Many Repetitions as Possible'}></Title>
                        </View>
                        {
                            ...
                            <View style={{ flexDirection: 'row', justifyContent:'space-around'}}>
                                <View style={{ flex: 1}}>
                                    ...
                                    <Text style={styles.subtitleStatistics}>por repetição</Text>
                                </View>
                                <View style={{ flex: 1}}>
                                    <Text style={styles.titleStatistics}>{estimated}</Text>
                                    <Text style={styles.subtitleStatistics}>repetições</Text>
                                </View>
                            </View> 
                            : null
                        }
